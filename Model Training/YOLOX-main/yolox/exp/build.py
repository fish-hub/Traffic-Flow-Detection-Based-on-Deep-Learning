...
def get_exp_by_file(exp_file):
    try:
        ...
        #os.path.basename(exp_file).split(".")[0]返回文件名
...
def get_exp_by_name(exp_name):
    ...
    module_name = ".".join(["yolox", "exp", "default", exp]) #'yolox.exp.default.exps/example/yolox_voc/yolox_voc_s.py'
...
def get_exp(exp_file=None, exp_name=None):
    ...
    if exp_file is not None:
        return get_exp_by_file(exp_file) #走的这
    else:
